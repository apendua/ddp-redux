...
export const DDP_RESOURCE_CREATE = '@DDP.RESOURCE.CREATE';
export const DDP_RESOURCE_DELETE = '@DDP.RESOURCE.DELETE';
export const DDP_RESOURCE_UPDATE = '@DDP.RESOURCE.UPDATE';

export const DDP_RESOURCE_REQUEST = '@DDP.RESOURCE.REQUEST';
export const DDP_RESOURCE_RELEASE = '@DDP.RESOURCE.RELEASE';
export const DDP_RESOURCE_REFETCH = '@DDP.RESOURCE.REFETCH';
export const DDP_RESOURCE_FETCH = '@DDP.RESOURCE.FETCH';
export const DDP_RESOURCE_DEPRECATE = '@DDP.RESOURCE.DEPRECATE';

export const DDP_RESOURCE_TYPE_QUERY = 'QUERY';
export const DDP_RESOURCE_TYPE_SUBSCRIPTION = 'SUBSCRIPTION';
